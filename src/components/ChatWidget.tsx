...
export default function ChatWidget() {
  useEffect(() => {
    const existingChat = document.getElementById("lk-chat");
    if (existingChat) {
    ...
    return () => {
      if (document.getElementById("lk-chat")) {
        document.getElementById("lk-chat").remove();
      }
      if (document.getElementById("lk-chat-style")) {
        document.getElementById("lk-chat-style").remove();
      }
    };
  }, []);
